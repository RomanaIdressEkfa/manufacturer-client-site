...
const Purseus = () => {
    ...
    const { name, picture, minimum_quantity, available_quantity, price: unitPrice } = product;
    ...
    const handleQuantity = (e) => {
        ...
        if (quantity >= minimum_quantity && quantity <= available_quantity) {
            setQuantity(quantity)
            const divide = unitPrice / minimum_quantity;
            ...
            <div className='flex justify-center items-center my-7'>
                <div className="card w-80 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p className='text-xs font-bold'>Stock: {available_quantity}</p>
                        <p className='text-xs font-bold'>Minimum Order: {minimum_quantity}</p>
                        {
