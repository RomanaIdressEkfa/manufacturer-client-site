...
const CountDown = () => {
    ...
    return (
        <div className='w-11/12 h-72 mx-auto my-20 bg-white py-3 rounded-br-3xl rounded-tl-3xl ' style={{ backgroundImage: `url(${background})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}> '
            <h1 className='text-center my-5 text-4xl font-bold'>Our new products<span className='text-error'> coming soon</span></h1>
